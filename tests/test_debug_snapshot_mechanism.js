...
(async()=>{
  ...
  console.log('Timpani in snapshot for row5?', window.eval(`
    seatSpacingCustomSnapshot && seatSpacingCustomSnapshot[5] && seatSpacingCustomSnapshot[5].seats.some(s=>s.id==='${timpaniId}')
  `));
