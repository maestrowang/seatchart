...
(async()=>{
  ...
  console.log('Manual seat IDs:', manualIds);
  console.log('Their rows:', window.eval(`${JSON.stringify(manualIds)}.map(id=>getSeat(id).row)`));
  console.log('Their rowShapes:', window.eval(`${JSON.stringify(manualIds)}.map(id=>chart.rowShapes[getSeat(id).row])`));
  ...
  console.log('rowSpacingCustomSnapshot:', window.eval('JSON.stringify(rowSpacingCustomSnapshot)'));
  console.log('rowsInSelection:', window.eval('JSON.stringify([...rowsInSelection()])'));
