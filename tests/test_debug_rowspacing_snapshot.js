...
(async()=>{
  ...
  console.log('rowSpacingCustomSnapshot after mousedown:', window.eval('JSON.stringify(rowSpacingCustomSnapshot)'));
  console.log('rowRadii at mousedown time:', window.eval('JSON.stringify(chart.rowRadii)'));

  slider.value = 105;
  slider.dispatchEvent(new window.Event('input', {bubbles:true}));
  await wait(20);

  console.log('rowRadii AFTER 105%:', window.eval('JSON.stringify(chart.rowRadii)'));
